					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								...
								<li><a href="#map" id="map-link" class="skel-layers-ignoreHref"><span class="icon fa-map-o">Map</span></a></li>
								<li><a href="#portfolio" id="portfolio-link" class="skel-layers-ignoreHref"><span class="icon fa-th">Images</span></a></li>
		...
		<!-- Main -->
			<div id="main">
				...
				<section id="map" class="two">
                    ...
                    <div id="map_container" class="map featured"></div>
					<!--<div class="container">-->

						<!--&lt;!&ndash;<header>&ndash;&gt;-->
							<!--&lt;!&ndash;<h2>Map</h2>&ndash;&gt;-->
						<!--&lt;!&ndash;</header>&ndash;&gt;-->
							<!--&lt;!&ndash;<a href="#" class="image featured"><img src="../images/pic08.jpg" alt="" /></a>&ndash;&gt;-->
							<!---->
						<!--<p></p>-->
